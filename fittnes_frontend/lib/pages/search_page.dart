...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<List<Workout>> getFilteredWorkouts() async {
    ...
    print(Uri.parse(
        'http://192.168.54.182:8080/api/selfCoach/user/getFilteredWorkouts?${makeRequestParamStringFromSearchFilter(filterSearch)}'));
  ...
  Future<List<Program>> getFilteredPrograms() async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://192.168.54.182:8080/api/selfCoach/user/getFilteredPrograms?${makeRequestParamStringFromSearchFilter(filterSearch)}'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
