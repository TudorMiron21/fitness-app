...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<List<Workout>> getFilteredWorkouts() async {
    ...
    print(Uri.parse(
        'https://fit-stack.online/api/selfCoach/user/getFilteredWorkouts?${makeRequestParamStringFromSearchFilter(filterSearch)}'));
  ...
  Future<List<Program>> getFilteredPrograms() async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://fit-stack.online/api/selfCoach/user/getFilteredPrograms?${makeRequestParamStringFromSearchFilter(filterSearch)}'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
