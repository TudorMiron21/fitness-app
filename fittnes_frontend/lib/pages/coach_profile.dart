...
class _CoachProfileState extends State<CoachProfile> {
  ...
  Future<List<Workout>> fetchCoachWorkouts(int coachId) async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://fit-stack.online/api/selfCoach/payingUser/getCoachWorkouts/$coachId'),
      headers: {
  ...
  Future<List<Program>> fetchCoachPrograms(int coachId) async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://fit-stack.online/api/selfCoach/payingUser/getCoachPrograms/$coachId'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
  ...
  Future<bool> checkIfCoachIsFollowedByUser(int coachId) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            'https://fit-stack.online/api/selfCoach/payingUser/isCoachFollowedByUser/$coachId'),
        headers: {
          'Authorization': 'Bearer $accessToken',
        },
      );
  ...
  Future<CoachDetails> getCoachDetails(int coachId) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            'https://fit-stack.online/api/selfCoach/payingUser/getCoachDetails/$coachId'),
        headers: {
          'Authorization': 'Bearer $accessToken',
        },
      );
  ...
  Future<void> toggleFollowCoach(int coachId) async {
    ...
    try {
      final response = await http.put(
        Uri.parse(
            'https://fit-stack.online/api/selfCoach/payingUser/toggleFollowCoach/$coachId'),
        headers: {
  ...
  Future<void> likeWorkout(Workout workout) async {
    ...
    final response = await http.put(
      Uri.parse('https://fit-stack.online/api/selfCoach/user/likeWorkout/' +
          workout.id.toString()),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
  ...
  Future<void> unlikeWorkout(Workout workout) async {
    ...
    final response = await http.delete(
      Uri.parse('https://fit-stack.online/api/selfCoach/user/unlikeWorkout/' +
          workout.id.toString()),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
