...
class _CoachProfileState extends State<CoachProfile> {
  ...
  Future<List<Workout>> fetchCoachWorkouts(int coachId) async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://192.168.54.182:8080/api/selfCoach/payingUser/getCoachWorkouts/$coachId'),
      headers: {
  ...
  Future<List<Program>> fetchCoachPrograms(int coachId) async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://192.168.54.182:8080/api/selfCoach/payingUser/getCoachPrograms/$coachId'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
  ...
  Future<bool> checkIfCoachIsFollowedByUser(int coachId) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.54.182:8080/api/selfCoach/payingUser/isCoachFollowedByUser/$coachId'),
        headers: {
          'Authorization': 'Bearer $accessToken',
        },
      );
  ...
  Future<CoachDetails> getCoachDetails(int coachId) async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.54.182:8080/api/selfCoach/payingUser/getCoachDetails/$coachId'),
        headers: {
          'Authorization': 'Bearer $accessToken',
        },
      );
  ...
  Future<void> toggleFollowCoach(int coachId) async {
    ...
    try {
      final response = await http.put(
        Uri.parse(
            'http://192.168.54.182:8080/api/selfCoach/payingUser/toggleFollowCoach/$coachId'),
        headers: {
