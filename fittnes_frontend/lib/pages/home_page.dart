...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<User>> fetchFollowingCoaches() async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://172.205.42.172/api/selfCoach/payingUser/getFollowingCoaches'),
      headers: {
  ...
  Future<List<Program>> fetchPrograms() async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://172.205.42.172/api/selfCoach/payingUser/getAllPrograms'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
  ...
  Future<List<Workout>> fetchirstSixMostLikedWorkouts() async {
    ...
    final response = await http.get(
      Uri.parse(
          'http://172.205.42.172/api/selfCoach/user/workouts/getFirstSixMostLikedWorkouts'),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
    );
  ...
  Future<List<Workout>> fetchirstSixMostLikedWorkoutsFromDifficultyLevel(
    ...
    final response = await http.get(
      Uri.parse(
          'http://172.205.42.172/api/selfCoach/user/workouts/getTopWorkoutsForDifficultyLevel/' +
              lowerLimit.toString() +
              '/' +
              upperLimit.toString()),
      headers: {
  ...
  Future<void> likeWorkout(Workout workout) async {
    ...
    final response = await http.put(
      Uri.parse('http://172.205.42.172/api/selfCoach/user/likeWorkout/' +
          workout.id.toString()),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
  ...
  Future<void> unlikeWorkout(Workout workout) async {
    ...
    final response = await http.delete(
      Uri.parse('http://172.205.42.172/api/selfCoach/user/unlikeWorkout/' +
          workout.id.toString()),
      headers: {
        'Authorization': 'Bearer $accessToken',
      },
