...
//        String username = template.getForObject("http://authorization-service:8082/api/v1/auth/getUsername?token=" + authHeader, String.class);
//
//        String[] authorities = template.getForObject("http://authorization-service:8082/api/v1/auth/getUserAuthorities?token=" + authHeader, String[].class);
