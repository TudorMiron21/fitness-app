    ...
    describe("WebPubSubClient handle messages", () => {
        it("Handle a list of messages", async () => {
            ...
            mock
                ...
                .returns([
                { kind: "serverData", data: "a", dataType: "text" },
                { kind: "serverData", data: "b", dataType: "text" },
            ]);
        ...
        it("Quick sequence ack if diff more than limit", async () => {
            ...
            mock.expects("parseMessages").returns([
                { kind: "serverData", data: "a", dataType: "text", sequenceId: 1 },
                { kind: "serverData", data: "a", dataType: "text", sequenceId: 302 },
            ]);
