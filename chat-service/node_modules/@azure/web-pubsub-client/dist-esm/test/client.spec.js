...
describe("WebPubSubClient", function () {
    describe("Construct a new client and options", () => {
        ...
        it("take options", () => {
            assert.doesNotThrow(() => {
                new WebPubSubClient({ getClientAccessUrl: async (_) => "wss://service.com" }, { protocol: WebPubSubJsonProtocol(), autoReconnect: false });
            });
        });
        it("protocol is missing", () => {
            assert.doesNotThrow(() => {
                const client = new WebPubSubClient({ getClientAccessUrl: async (_) => "wss://service.com" }, { autoReconnect: false });
        ...
        it("reconnectionOptions is missing", () => {
            assert.doesNotThrow(() => {
                const client = new WebPubSubClient({ getClientAccessUrl: async (_) => "wss://service.com" }, {});
                const options = client["_options"];
