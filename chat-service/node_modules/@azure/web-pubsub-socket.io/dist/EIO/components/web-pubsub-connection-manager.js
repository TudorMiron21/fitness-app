...
exports.WebPubSubConnectionManager = void 0;
const utils_1 = require("../../common/utils");
const client_connection_context_1 = require("./client-connection-context");
const constants_1 = require("./constants");
const web_pubsub_express_1 = require("@azure/web-pubsub-express");
const debug = (0, utils_1.debugModule)("wps-sio-ext:EIO:ConnectionManager");
/**
 ...
 */
class WebPubSubConnectionManager {
    /**
    ...
    constructor(server, options) {
        this.service = (0, utils_1.getWebPubSubServiceCaller)(options);
        this.eioServer = server;
        this._webPubSubOptions = options;
        this._webPubSubEventHandler = new web_pubsub_express_1.WebPubSubEventHandler(this._webPubSubOptions.hub, {
            path: constants_1.TUNNEL_PATH,
                ...
                try {
                    ...
                    cleanup = (error) => {
                        ...
                        const connectionError = {
                            req: req,
                            code: constants_1.CONNECTION_ERROR_WEBPUBSUB_CODE,
                            message: constants_1.CONNECTION_ERROR_WEBPUBSUB_MESSAGE,
                            context: error,
                        };
                        this.eioServer.emit(constants_1.CONNECTION_ERROR_EVENT_NAME, connectionError);
                    };
                    const context = new client_connection_context_1.ClientConnectionContext(this.service, connectionId, res, cleanup);
                    /**
     ...
     */
    getEventHandlerExpressMiddleware() {
        return this._webPubSubEventHandler.getMiddleware();
    }
    getNextSid = () => this._candidateSids.shift();
    async close() {
     ...
     */
    getEioHandshakeRequest(req, context) {
        /**
        ...
        handshakeRequest._query["transport"] = constants_1.WEBPUBSUB_TRANSPORT_NAME;
        ...
        handshakeRequest[constants_1.WEBPUBSUB_CLIENT_CONNECTION_FILED_NAME] = context;
        return handshakeRequest;
    }
}
exports.WebPubSubConnectionManager = WebPubSubConnectionManager;
//# sourceMappingURL=web-pubsub-connection-manager.js.map