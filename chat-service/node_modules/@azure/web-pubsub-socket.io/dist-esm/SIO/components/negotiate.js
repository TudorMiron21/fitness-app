import { debugModule, getWebPubSubServiceClient, writeResponse, } from "../../common/utils";
 ...
 * @returns
 */
export function negotiate(io, configureNegotiateOptions) {
    debug(`getNegotiateExpressMiddleware`);
    const wpsOptions = io instanceof SIO.Server ? io[WEB_PUBSUB_OPTIONS_PROPERY_NAME] : io;
 ...
 * @returns
 */
export function usePassport(assignProperty = "user") {
