...
export class WebPubSubTransport extends Transport {
    ...
    constructor(req, sioMode = true) {
        ...
        this._encodeEioPacketAsync = toAsync(this.parser.encodePacket);
        this._encodeEioPayloadAsync = toAsync(this.parser.encodePayload);
    }
    supportsFraming = () => false;
    name = () => WEBPUBSUB_TRANSPORT_NAME;
    /**
...
_buffer=${JSON.stringify(this._buffer)}`);
    ...
    _getPacketNumberForNextSend(packets) {
        ...
        for (let i = 0; i < packets.length; i++) {
            ...
            const sioPacket = decodeStringPartial(eioPacket.data);
