...
export const ExerciseCard = ({ exercise }) => {
  ...
  return (
    <div className={`exercise-card ${isSelected ? 'selected' : ''}`} onClick={toggleSelect}>
      ...
      <div className="exercise-details">
        ...
        <ul className="exercise-info">
          <li><strong>Muscle Group:</strong> {exercise.muscleGroup?.name}</li>
          <li><strong>Equipment:</strong> {exercise.equipment?.name}</li>
          <li><strong>Difficulty:</strong> {exercise.difficulty?.dificultyLevel}</li>
          <li><strong>Category:</strong> {exercise.category?.name}</li>
          <li><strong>Exclusive:</strong> {exercise.isExerciseExclusive ? 'Yes' : 'No'}</li>
        </ul>
      </div>
    </div>
  );
